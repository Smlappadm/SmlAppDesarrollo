...
//   <motion.div
//     className="flex"
//     initial={{ x: -200 }} // Ancho inicial en 0
//     animate={{ x: 0 }} // Ancho final al 100% (se ajusta automáticamente al ancho del contenedor padre)
//     transition={{ duration: 0.5 }} // Duración de la animación en segundos y tipo de transición "tween"
//   >
//     <div className="flex ml-[55px] p-0">
//       <Link to={item.url} target="_blank">
...
//     className="flex"
//     initial={{ x: -200 }} // Ancho inicial en 0
//     animate={{ x: 200 }} // Ancho final al 100% (se ajusta automáticamente al ancho del contenedor padre)
//     transition={{ duration: 0.5 }} // Duración de la animación en segundos y tipo de transición "tween"
//   >
